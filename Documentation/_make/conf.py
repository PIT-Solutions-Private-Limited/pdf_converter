# -*- coding: utf-8 -*-
#
# Page to Pdf documentation build configuration file, created by
# TYPO3 extension sphinx on Thu, 11 Oct 2018 11:45:59 +0530.
#
...
project = u'Page to Pdf'
copyright = u'2018, Kasim Sabah'
...
htmlhelp_basename = 'pdf_converterdoc'
...
latex_documents = [
    ('Index', 'pdf_converter.tex', u'Page to Pdf',
     u'Kasim Sabah', 'manual'),
]
...
pdf_documents = [
    ('Index', 'pdf_converter', u'Page to Pdf',
     u'Kasim Sabah'),
]
...
texinfo_documents = [
    ('Index', 'pdf_converter', u'Page to Pdf',
     u'Kasim Sabah', 'Page to Pdf', 'One line description of project.',
     'Miscellaneous'),
]
